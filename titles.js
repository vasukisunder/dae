const titles = [
    "constantly feel like they may have shit themselves in social settings?",
    "get an extreme ache when thinking about how much you love animals?",
    "HATE wishes?",
    "have Frequent Dissociations?",
    ...
    "think Crazy Bitch is the worst song of all time?",
    ...
    "feel like being able to hide your posts and comments from users feel like it’s cheating?",
    ...
    "get triggered or emotional when it comes to food stories ? Possible TW..",
    ...
    "get great results from ChatGPT for a while, then it just deteriorates?",
    ...
    "hate sleep?",
    "notice an increase in random and new subreddits being pushed to your feed?",
    ...
    "else wonder why we stopped playing with toys .",
    ...
    "wonder how hard an ugly stripper has to work in order to make ends meet?",
    "bite themselves??",
    "avoid sports broadcasts with female announcers?",
    "avoid joining webconferences unless >2 others are already present, to avoid small talk?",
    "get the first letter of words mixed up a lot?",
    ...
    "not do the \"criss-cross arms\" move to take their top off?",
    ...
    "see the new KIA logo and think of the NIN symbol?",
    ...
    "ever bugged for downvotes on Reddit?",
    ...
    "have problems with reddit not responding or just lagging so much?",
    ...
    "simply not care about karma? (Reddit)",
    ...
    "get a warm fuzzy feeling watching some genius copy-paste the exact same masterpiece into 17 subs like Reddit’s gonna hand them a trophy?",
    ...
    "else think reddit should limit threads to 100 responses and then start another thread?",
    ...
    "not feel offended with invitations that are “kid-free” or adult only events?",
    ...
    "think that Daniel Radcliffe would make a good Ozzy Osbourne in a biopic",
    "get sad about stores not having a lot of customers?",
    "shit and browse Reddit or am I the only one?",
    "not drink water",
    "Hate airports?",
    ...
    "wonder why cars don’t constantly hit each other by trying to move into the lane between them at the same time?",
    ...
    "not remember the last time they opened Reddit on a laptop it was so long ago?",
    ...
    "remember getting their skin pinched for fat levels in high school?",
    ...
    "Use Shampoo On Underarm Hair?",
    "remember hearing the song A Garden - Novial Music, Before its release date (24th July 2024)",
    ...
    "thank Chat GPT after it gives you an answer and you are done talking to it?",
    "think the smell of gasoline smells good?",
    "immediately close a reddit post without reading if it is a one long paragraph without any visual separation?",
    "have tv volumes that are comfortable for you",
    "Remember the sneeze.com?",
    ...
    "not know what to do about rubber gloves when someone wants to shake hands?",
